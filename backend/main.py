...
def export_prescription_pdf(doc_id: str):
    ...
    c.drawString(50, h - 50, "COMPUTERIZED SMART PRESCRIPTION")
...
def send_automated_notification(case: dict):
    ...
    # Fixed redundant datetime import
...
The payment of Rs.{amount} has been processed successfully to the hospital.

Details of Settlement:
- UTR Number: {utr}
- Transaction Date: {date}
- Total Final Paid Amount: Rs.{amount}
...
def export_rcm_csv():
    ...
    # Removed redundant 'import io' and 'import pandas as pd' as they are at the top
