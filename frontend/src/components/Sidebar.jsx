...
const NAV_HOSPITAL = [
  ...
  { id: 'forms',     icon: FormsSVG, label: 'Download Forms' },
  { id: 'analytics', icon: <div className="icon-3d lg icon-side icon-data float" />,  label: 'Analytics' },
  { id: 'settings',  icon: SettingsSVG, label: 'Settings' }
]
